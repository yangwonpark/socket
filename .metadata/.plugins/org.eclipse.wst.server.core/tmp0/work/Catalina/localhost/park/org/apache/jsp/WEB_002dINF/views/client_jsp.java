 ...
 * Generated at: 2021-04-11 07:29:55 UTC
...
public final class client_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\r\n");
      out.write("\r\n");
      out.write("\t<h3>Client</h3>\t\r\n");
      out.write("\t<!-- 채팅 영역 -->\r\n");
      out.write("\t<div class=\"container\">\r\n");
      out.write("\t\t<div id=\"user-container\" class=\"chat-container2\" style=\"display: none\">\r\n");
      ...
      out.write("\t\t\t\t<input class=\"text-msg\" type=\"text\" onkeydown=\"return enter()\">\r\n");
      out.write("\t\t\t\t<input type=\"button\" class=\"send-btn\" value=\"전송\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<br/>\t\t\r\n");
      out.write("\t\t<div id=\"enter-container\">\r\n");
      out.write("\t\t\t<input disabled=\"disabled\" type=\"hidden\" id=\"name\" style=\"border: none; background: none;\" value=\"");
      ...
      out.write("\">\r\n");
      out.write("\t\t\t<button id=\"enter-btn\" class=\"btn-qa\">1:1 문의</button>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("<script>\r\n");
      out.write("\tconst chatArea = document.querySelector(\".chat-area\");\r\n");
      out.write("// \tconst chatArea = document.getElementById(\"chat-area\");\r\n");
      out.write("\tconst enterBtn = document.getElementById(\"enter-btn\");\r\n");
      out.write("\tconst sendBtn = document.querySelector(\".send-btn\");\r\n");
      out.write("// \tconst sendBtn = document.getElementById(\"send-btn\");\r\n");
      out.write("\tconst chatContainer = document.querySelector(\".chat-container2\")\r\n");
      out.write("// \tconst chatContainer = document.getElementById(\"chat-container\")\r\n");
      out.write("\tconst textMsg = document.querySelector('.text-msg');\r\n");
      out.write("// \tconst textMsg = document.getElementById('text-msg');\r\n");
      out.write("\tconst btnQa = document.querySelector('.btn-qa');\r\n");
      out.write("\t\r\n");
      out.write("\tlet toggleCheck = false;\r\n");
      out.write("\t\r\n");
      out.write("\t// enterBtn click이벤트 최초 실행 후 이벤트 기능 상실\r\n");
      out.write("\t// onclick보다 addEventListener가 더 최신 문법이다...\r\n");
      out.write("\tenterBtn.addEventListener('click', function(e) {\r\n");
      out.write("\t\tconsole.log(e.target.previousElementSibling.value);\r\n");
      out.write("\t\tconnect(e.target.previousElementSibling.value);\r\n");
      out.write("\t}, {once : true});\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\tbtnQa.onclick = (e) => {\r\n");
      out.write("\t\tif(toggleCheck) {\r\n");
      out.write("\t\t\ttoggleCheck = false;\r\n");
      out.write("\t\t\tchatContainer.style.display = 'none';\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\ttoggleCheck = true;\r\n");
      out.write("\t\t\tchatContainer.style.display = 'block';\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tsendBtn.onclick = (e) => {\r\n");
      out.write("\t\tsendMessage();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tlet sock;\r\n");
      out.write("\t\r\n");
      out.write("\tfunction connect(name) {\r\n");
      out.write("\t\tsock = new SockJS('http://172.30.1.58:8080/park/clientEcho');\r\n");
      out.write("\t\t// 웹 소켓 자체에 내장 메소드 4개 \r\n");
      out.write("\t\tsock.onopen = onOpen;\r\n");
      out.write("\t\tsock.onmessage = onMessage;\r\n");
      out.write("\t\tsock.onclose = onClose;\r\n");
      out.write("\t\tsock.onerror = onError;\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("// \t\tchatContainer.style.display = 'block';\r\n");
      out.write("\t\t// 웹소켓 내장 메소드\r\n");
      out.write("// \t\tsock.send(name + \"님 입장\");\r\n");
      out.write("\t\tchatArea.innerHTML = \"\";\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction onError() {\r\n");
      out.write("\t\tchatArea.innerHTML += \"연결에 실패했습니다. <br> 재접속 하세요\";\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\tchatArea.innerHTML += \"<span class='chat--left'>\" +\r\n");
      out.write("\t\t\t\"<span class='chat-user'>관리자<br>\" +\r\n");
      out.write("// \t\t\t\"<span class='chat-content'>\" + message.data + \"</span><br>\"\r\n");
      out.write("\t\t\t\"<span class='chat-content'>\" + message.data + \"</span>\"\r\n");
      out.write("// \t\t\t\"<span class='chat-time'>\" + realDate + \"</span>\";\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction onClose() {};\r\n");
      out.write("\t\r\n");
      out.write("\t// 이 함수가 가지고 있는 sock.send가 맞은편 소켓의 대상의 onMessage와 연결되어있다고 보면 됌\r\n");
      out.write("\tfunction sendMessage(message) {\r\n");
      out.write("\t\tconst liveName = document.getElementById('name').value;\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tconsole.log(message);\r\n");
      out.write("\t\t\r\n");
      out.write("// \t\tlet time = message.timeStamp\r\n");
      ...
      out.write("// \t\tconsole.log(realDate);\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tchatArea.innerHTML += \"<span class='chat--right'>\" + \r\n");
      out.write("\t\t\"<span class='chat-user'>\" + liveName + \"<br>\" +\r\n");
      out.write("\t\t\"<span class='chat-content'>\" + textMsg.value + \"</span><br>\"\r\n");
      out.write("// \t\t\"<span class='chat-time'>\" + realDate + \"</span>\";\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tconsole.log(textMsg.value);\r\n");
      out.write("\t\t// liveName(회원 이름)과 textMsg.value(텍스트 내용)를 :로 엮어서 넘겨줌\r\n");
      out.write("\t\t//\r\n");
      out.write("\t\tsock.send(liveName + \":\" + textMsg.value);\r\n");
      out.write("\t\t\r\n");
      out.write("\t\ttextMsg.value = \"\";\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
